...
<!-- NAV BAR1-->     
  <nav class="navbar navbar-expand-md" style="background-color: #121111;">
    ...
    <div class="collapse navbar-collapse" id="main-navigation">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="Login.php"><img src ="assets/images/profile.png" alt="logo" width="40px"></a></li>
        </ul>
    </div>
  </nav>                                        
 <!--END OF NAVBAR -->
...
<!-- NAV BAR2-->     
    <div class="content">                                                 
        <a class="nav2-link" href="Login.php">Discover</a>
        <a class="nav3-link" href="browse.php">Browse</a></div> 
<!-- END OF NAV BAR2--> 
...
<!-- CATALOG -->
                ...
                <div class="btn-collection-playing my-4">
                    ...
                    <button class="btn btn-custom"> <a href="Login.php">LEARN MORE</button></a></div>
<!-- END OF CATALOG -->
